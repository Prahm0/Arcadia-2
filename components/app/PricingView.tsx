...
const TIERS: Tier[] = [
  {
    key: "free",
    name: "Free",
    headline: "See if Arcadia clicks for you.",
    priceWeekly: null,
    priceMonthly: null,
  ...
  },
  {
    key: "pro",
    name: "Pro",
    headline: "For everyone actually studying.",
    priceWeekly: 3.99,
    priceMonthly: 15.99,
    billingNote: "Billed monthly. Cancel anytime.",
    features: [
      "Everything in Free",
      "Unlimited Arcad chat",
      "Google / Apple / Canvas calendar sync",
      "Knowledge uploads (PDFs, notes)",
  ...
  },
  {
    key: "max",
    name: "Max",
    headline: "For serious study weeks.",
    priceWeekly: 9.99,
    priceMonthly: 39.99,
    billingNote: "Billed monthly. Cancel anytime.",
    features: [
      "Everything in Pro",
      "Voice Arcad (talk to it, hands-free)",
      "1:1 tutor bookings (coming soon)",
      "Priority Arcad responses",
      "Custom AI study personas",
