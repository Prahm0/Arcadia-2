  ...
  return (
    <>
      <button
        ...
        className="inline-flex h-8 items-center gap-1.5 rounded-md px-2.5 text-[13px] font-medium ui-hover max-lg:w-8 max-lg:justify-center max-lg:px-0"
        style={{ color: "var(--app-text-soft)" }}
      >
        <svg aria-hidden="true" viewBox="0 0 16 16" width="14" height="14" fill="none" stroke="currentColor" strokeWidth="1.4" className="max-lg:size-4">
        ...
        {/* Just the icon on phones, where header space is tight. */}
        <span className="max-lg:sr-only">How it works</span>
      </button>
